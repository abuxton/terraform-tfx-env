locals {
  tfe_git_commit = substr(var.atlas_configuration_version_github_commit_sha, -6, -1)
  tfc_git_commit = substr(var.tfc_configuration_version_git_branch, -6, -1)
  tfx-env-map = {
    ...
    "tfe_git_commit"                                = local.tfe_git_commit,
    "tfc_git_commit"                                = local.tfc_git_commit
  }
}
